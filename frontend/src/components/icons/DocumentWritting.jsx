...
export function IconIdeaDocument(props) {
	return (<svg
...
// Exportación por defecto para la compatibilidad con diferentes estilos de importación
export default IconIdeaDocument;
